...
?>
<br>
<h1>Email :</h1> <?php echo $user['email'];?> 
<br>	  
<h1>User #</h1> <?php echo $user['tracking_id'];?>
<br>
...
<h1>Site:</h1>  <?php echo $user['site_info']['code'];?><br>
<h1>Site Description: </h1> <div id="sitedes"><?php  
 	if (isset($mgr)){
